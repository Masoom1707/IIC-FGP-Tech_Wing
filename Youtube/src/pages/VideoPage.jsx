      ...
      <div className="left_side">
        ...
        <div className="title">
          ...
          <div className="cancel_comment">
            <div className="comment_button hover1">
                Cancel
            </div>
            <div className="comment_button hover2">
                Comment
            </div>
            </div>
            ...
            <img src="../public/images (1).jpg" alt="profile" />
            <div className="input_div">
                <h3>Masoom <span>09-12-2024</span></h3>
                <p className="comment">This is the best Youtube design that i've buid</p>
            </div>
          </div>
            <div className="comment_input comments">
            <img src="../public/images (1).jpg" alt="profile" />
